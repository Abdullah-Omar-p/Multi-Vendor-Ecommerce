...
class OrderController extends Controller
{
    public function list()
    {
        try {
            ...
            return Helper::responseData('Failed to fetch orders', false, null, 500);
        }
    }
    ...
    public function store(StoreOrderRequest $request)
    {
        try {
            ...
            return Helper::responseData('Failed to create order', false, null, 500);
        }
    }
    ...
    public function show(int $orderId)
    {
        try {
            ...
            return Helper::responseData('Failed to fetch order', false, null, 500);
        }
    }
    ...
    public function cancel(int $orderId)
    {
        try {
            ...
            return Helper::responseData('Failed to delete order', false, null, 500);
        }
    }
}
